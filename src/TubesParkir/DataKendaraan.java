...
public class DataKendaraan extends javax.swing.JFrame {
    ...
    public void getData( ){
         ...
         try{
               Statement st = con.createStatement();
                String sql = "Select * from TblKendaraan where Deleted = 0";
                ResultSet rs = st.executeQuery(sql);
               while(rs.next ()){
                    Object[] obj = new Object[7];
                    obj[0] = rs.getString("IDKendaraan");
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(485, 444));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if(a==0){
        try{
            int row = TblKend.getSelectedRow();
            String cell = TblKend.getModel().getValueAt(row, 0).toString();
            String sql="update TblKendaraan set Deleted = 1 where IDKendaraan = '"+cell+"'";
